...
CREATE TABLE [dbo].[DOCTOR] (
    [idDoctor]     INT           IDENTITY (200, 1) NOT NULL,
...
CREATE TABLE [dbo].[PATIENT] (
    [idPatient]    INT           IDENTITY (100, 1) NOT NULL,
    [idPassport]   NVARCHAR (20) NOT NULL,
    [fullName]     NVARCHAR (50) NULL,
...
GO
PRINT N'Creating [dbo].[SPECIALIST]...';


GO
CREATE TABLE [dbo].[SPECIALIST] (
    [idSpecialist] INT           IDENTITY (10, 1) NOT NULL,
    [fullName]     NVARCHAR (50) NULL,
    [location]     NVARCHAR (20) NULL,
    PRIMARY KEY CLUSTERED ([idSpecialist] ASC)
);


GO
PRINT N'Creating [dbo].[FK_idSpecialistDoctor_ToSPECIALIST]...';


GO
ALTER TABLE [dbo].[DOCTOR]
    ADD CONSTRAINT [FK_idSpecialistDoctor_ToSPECIALIST] FOREIGN KEY ([idSpecialist]) REFERENCES [dbo].[SPECIALIST] ([idSpecialist]);
